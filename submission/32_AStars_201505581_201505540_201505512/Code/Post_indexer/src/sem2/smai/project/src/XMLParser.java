...
public class XMLParser {
	...
	public void init_parser(String filepath,int start, int limit){
		try{
			c = 0;
				...
				public void startElement(String uri, String localName, String qName, Attributes attributes)
					...
					if(qName.equals("row")){
						...
						if(postTypeId.equals("1")){
							...
							String body = attributes.getValue("Body"); // Title
...
//							rt.test(post);
	...
	public static void main(String[] args) {
		...
		p.init_parser(args[0], Integer.parseInt(args[1]), Integer.parseInt(args[2]));
