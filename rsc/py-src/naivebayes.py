...
def test_data(filepath):
	...
	for line in test_file_desc.readlines():
		...
		ct+=1
		logging.info("Processing : "+str(ct))
		assigned_tags = []
	...
	print total_classified,",",true_classified,",",total_classified,",",(float(true_classified)/float(total_classified))*100

for i in range(5,51,5):
	test_data("title-index/title-tag-"+str(i)+"k.out")